...
from src.cleaning import clean_data_lemma, split_tax
...
df_companies_clean = clean_data_lemma(df_companies.copy())
df_taxonomy_clean = clean_data_lemma(df_taxonomy.copy())
...
stats = save_sim_values_csv(df_best_values, out_path="./data/split_lemma_values.csv")

df_companies.to_csv("companies_lab_split_lemma.csv")
